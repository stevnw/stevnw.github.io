...
const wordSets = { // 1 - 25
    1: [
		...
		{ simp:"白（形）", trad: "白", pinyin: "bái", pinyinalt: "bai2", zhuyin: "ㄅㄞˊ", meaning: "white, snowy, empty, blank, clear, bright" },
		...
		{ simp:"本（量）", trad: "本", pinyin: "běn", pinyinalt: "ben3", zhuyin: "ㄅㄣˇ", meaning: "origin, source, roots/stems of pants, basis, foundation" },
		{ simp:"本子", trad: "本子", pinyin: "běn zi", pinyinalt: "ben3 zi", zhuyin: "ㄅㄣˇ ㄗ˙", meaning: "book, notebook, edition" },
		...
		{ simp:"别（副）", trad: "別", pinyin: "bié", pinyinalt: "bie2", zhuyin: "ㄅㄧㄝˊ", meaning: "leave, depart, seperate, distinguish, seperate, classify, do not, must not" }
	],
    2: [ // 26 - 50
